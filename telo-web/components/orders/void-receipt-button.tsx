  ...
  return (
    <>
      <button
        ...
        className="rounded px-1 py-0.5 text-[10px] font-medium uppercase tracking-wide text-zinc-400 transition-colors hover:bg-destructive/10 hover:text-destructive"
